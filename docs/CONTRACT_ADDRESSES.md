...
1. ✅ **POIToken** - 基础代币合约
2. ✅ **StakingRewards** - 质押奖励
3. ✅ **VestingVault** - 锁仓金库
4. ✅ **MerkleAirdropDistributor** - 空投分发
5. ✅ **EarlyBirdAllowlist** - 早鸟白名单
6. ✅ **TGESale** - TGE 销售合约
...
**所有合约配置文件：**
- ✅ `shared/contracts/poi.json` - POIToken
- ✅ `shared/contracts/staking_rewards.json` - StakingRewards
- ✅ `shared/contracts/vesting_vault.json` - VestingVault
- ✅ `shared/contracts/merkle_airdrop.json` - MerkleAirdropDistributor
- ✅ `shared/contracts/early_bird_allowlist.json` - EarlyBirdAllowlist
- ✅ `shared/contracts/poi_tge.json` - TGESale
- ✅ `shared/contracts/referral_registry.json` - ReferralRegistry
- ✅ `shared/contracts/achievement_badges.json` - AchievementBadges
- ✅ `shared/contracts/immortality_badge.json` - ImmortalityBadge
