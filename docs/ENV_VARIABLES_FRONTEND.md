...
- `VITE_VESTING_VAULT_ADDRESS`: VestingVault 锁仓金库地址
- `VITE_MERKLE_AIRDROP_ADDRESS`: MerkleAirdropDistributor 空投分发地址
- `VITE_EARLY_BIRD_ALLOWLIST_ADDRESS`: EarlyBirdAllowlist 白名单地址
